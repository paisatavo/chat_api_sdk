...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChatApiSdk.GroupParticipantAction();
  });
  ...
  describe('GroupParticipantAction', function() {
    it('should create an instance of GroupParticipantAction', function() {
      ...
      //var instane = new ChatApiSdk.GroupParticipantAction();
      //expect(instance).to.be.a(ChatApiSdk.GroupParticipantAction);
    });
